...
class Comment extends amplify_core.Model {
  ...
  const Comment._internal({required this.id, required content, post, createdAt, updatedAt}): _content = content, _post = post, _createdAt = createdAt, _updatedAt = updatedAt;
